...
ggplot(Country_study_top, aes(x=`No of Studies`, y=country,fill =country))+
  ...
  theme_minimal()
```
From the studies conducted, United States leads on the No of studies being conducted with Kenya, South Africa and Uganda being among the top in conducting studies in Africa.
...
ggplot(top_colaborators, aes(x=`No of studies`, y= Collaborators ))+
  ...
  labs(title= "Common colaborators")+
  theme_minimal()
```
