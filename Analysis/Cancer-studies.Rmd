...
ggplot(Country_study_top, aes(x=`No of Studies`, y=country,fill =country))+
  ...
  theme_minimal()
```
From the studies conducted, United States leads on the No of studies being conducted.
Recommendation: Countries In Africa should increase their research related to Cancer.
...
ggplot(plot_conditions, aes(x= `No of studies`, y = Conditions, fill= Conditions))+
  ...
  theme_minimal()
```
From graph, Most studies involve study on Breast Cancer.
