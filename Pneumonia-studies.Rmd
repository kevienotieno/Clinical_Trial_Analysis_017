...
ggplot(Country_study_top, aes(x=`No of Studies`, y=country,fill =country))+
  ...
  theme_minimal()
```
From the studies conducted, United States leads on the No of studies being conducted and In Africa the leading country is Egypt.
...
```
From the graph most studies involved age group of adults.

#Investigating the study status
```{r}
#grouping the data according to Study Status
study_status= Pneumonia %>% 
